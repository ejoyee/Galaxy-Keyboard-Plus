...
"""
간단한 FastAPI 테스트 앱
airbnb_caching 엔드포인트만 포함하여 테스트
"""
...
# 간단한 테스트 앱 생성
app = FastAPI(
    title="Airbnb Caching Test",
    description="airbnb_caching 엔드포인트 테스트용 앱",
    version="1.0.0"
)

@app.get(
    "/search/airbnb/caching",
...
@app.get("/")
async def root():
    return {"message": "Airbnb Caching Test API", "docs": "/docs"}

if __name__ == "__main__":
    import uvicorn
    print("간단한 테스트 서버 시작...")
    print("FastAPI Docs: http://localhost:8051/docs")
    print("airbnb_caching 엔드포인트: http://localhost:8051/search/airbnb/caching")
